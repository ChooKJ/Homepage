...
<body>
	...
	<section>
	<form name="boardWriteForm" action="boardProcess2.jsp" method="post" onsubmit="return boardWriteCheck();">
	<input type="hidden" name="mode" value="W" />
	<table border="1" summary="리뷰 게시판 등록 폼" style="background-color:gray;">
		<caption>리뷰 게시판 등록 폼</caption>
		<colgroup>
			<col width="100" />
			<col width="100" />
			<col width="100" />
